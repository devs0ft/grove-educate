...
function ChannelCard({
  ...
  return (
    <div className="flex flex-col items-center bg-white px-5 py-8 mr-8 mb-8 w-48 shadow-sm hover:shadow-md rounded">
      {svg && svg}
      {!svg && (
        <img className="object-cover h-24 w-24" alt="Channel logo" src={logo} />
      )}

      <p className="font-medium tracking-normal mt-8 ">{name}</p>
      <div className="mt-6">
      ...
      <div>
        ...
        <div className="flex items-center justify-start flex-wrap">
          <ChannelCard
            name="Messenger"
            active={true}
            logo="/static/facebook.1.png"
            svg={
              <svg
                className="fill-current text-blue-800 w-24 h-24"
          ...
          <ChannelCard
            name="WhatsApp"
            active={true}
            logo="/static/whatsapp.1.png"
            svg={
              <svg
                className="fill-current text-green-500 w-24 h-24"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <ChannelCard
            name="Twitter"
            active={true}
            logo="/static/twitter1.png"
            svg={
              <svg
                className="fill-current text-blue-600 w-24 h-24"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <ChannelCard
            ...
            svg={
              <svg
                className="fill-current text-red-500 w-24 h-24"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
              >
          ...
          <ChannelCard
            ...
            svg={
              <svg
                className="fill-current text-orange-500 w-24 h-24"
                xmlns="http://www.w3.org/2000/svg"
